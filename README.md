...
<img width="692" height="155" alt="image" src="https://github.com/user-attachments/assets/898235de-fdd3-4aac-8186-89665c80f720" />
<img width="821" height="637" alt="image2" src="https://github.com/user-attachments/assets/46d38a36-0f59-4719-86d9-e78d100b6461" />
...
![gif1](https://github.com/user-attachments/assets/d248797e-cb8b-4290-a5b2-52c4cbe69ebc)
...
### 해결 방안 1 - 검색 요청을 처리하는 Route Handler 구현
...
### 해결 방안 3 - 카테고리별 suffix를 활용한 외부 리뷰 검색 및 요약
...
예를 들어 음식 카테고리에서는 `"프레드 피자" 맛 평가 양 가성비 솔직 후기 메뉴 추천`처럼 검색어를 보완해, 단순 정보성 결과보다 실제 후기 문서가 더 우선적으로 수집되도록 했습니다.

### 해결 방안 4 - 검색 결과 없음 화면을 챗봇 진입점으로 전환
...
### 해결 방안 5 - 복잡한 입력 단계를 대화로 숨기는 단계형 챗봇 UX 구현
